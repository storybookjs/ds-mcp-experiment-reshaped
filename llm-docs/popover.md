    ...
    >
      ...
      <Popover.Content>
        <View padding={6} gap={3}>
          ...
          <p>
            This popover has a fixed width of 400px and opens to the
            bottom-start.
          </p>
...
function DismissiblePopover() {
  return (
    <Popover defaultActive>
      <Popover.Trigger>
        {(attributes) => (
          <Button attributes={attributes}>Open Dismissible Popover</Button>
        )}
      </Popover.Trigger>
      <Popover.Content>
...
function HoverPopover() {
  return (
    <Popover triggerType="hover" position="top" padding={3}>
      <Popover.Trigger>
